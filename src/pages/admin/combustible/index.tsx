...
export default function GastosCombustible() {
  ...
  const [filtroFechaDesde, setFiltroFechaDesde] = useState(() => '2026-04-13'); // Desde lunes 13
  const [filtroFechaHasta, setFiltroFechaHasta] = useState(() => '2026-04-19'); // Hasta domingo 19
