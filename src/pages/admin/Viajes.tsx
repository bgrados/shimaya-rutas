...
export default function AdminViajes() {
  ...
  const getRouteTheme = (nombre: string) => {
    ...
    if (n.includes('oeste') || n.includes('centro') || n.includes('amarilla')) return { bg: 'bg-yellow-950 border-yellow-800', text: 'text-yellow-400', icon: 'text-yellow-500' }; // Amarilla
