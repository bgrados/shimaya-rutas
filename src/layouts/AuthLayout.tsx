...
export const AuthLayout: React.FC = () => {
  ...
  // Se eliminó la redirección automática para evitar bucles. 
  // La redirección ahora se maneja en el componente Login.tsx o manualmente.
    ...
    <div className="min-h-screen bg-background text-text flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-10 flex flex-col items-center">
          ...
          {/* Círculo Principal del Logo (Igual que el logo de Ramen, fondo negro) */}
          <div className="bg-black w-40 h-40 rounded-full flex flex-col items-center justify-center border-4 border-black shadow-2xl mb-6 relative hover:scale-105 transition-transform duration-300">
            {/* Ícono de Camión (Reemplazando el tazón de ramen) en blanco */}
            <Truck size={72} strokeWidth={1.5} className="text-white mb-2" />
          </div>

          {/* Nombre SHIMAYA en Rojo Intenso (Impact / bold) */}
          ...
          {/* "- rutas -" en estilo clásico con líneas laterales */}
          ...
          {/* Texto de adorno al estilo japonés ('ルート' significa Rutas/Route) en Rojo */}
                ...
                <div className="flex flex-col gap-2 w-full mt-4">
                  ...
                  <button 
                    onClick={() => {
                      ...
                      import('../lib/supabase').then(m => m.supabase.auth.signOut().then(() => {
